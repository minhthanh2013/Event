...
-- AddForeignKey
ALTER TABLE "Host" ADD CONSTRAINT "Host_conferenceID_fkey" FOREIGN KEY ("conferenceID") REFERENCES "Conference"("conferenceID") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PaymentMethod" ADD CONSTRAINT "PaymentMethod_ticketID_fkey" FOREIGN KEY ("ticketID") REFERENCES "Ticket"("ticketID") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PaymentMethod" ADD CONSTRAINT "PaymentMethod_subscriptionID_fkey" FOREIGN KEY ("subscriptionID") REFERENCES "Subscription"("subscriptionID") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ConferenceCategory" ADD CONSTRAINT "ConferenceCategory_conferenceID_fkey" FOREIGN KEY ("conferenceID") REFERENCES "Conference"("conferenceID") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConferenceType" ADD CONSTRAINT "ConferenceType_conferenceID_fkey" FOREIGN KEY ("conferenceID") REFERENCES "Conference"("conferenceID") ON DELETE SET NULL ON UPDATE CASCADE;
